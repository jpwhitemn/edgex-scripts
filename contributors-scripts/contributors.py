...
for repo in repos.json():
	if not (repo['name'].startswith('docker')):
		print('---------------')
		print(repo['name'])
		contrib_data = requests.get('https://api.github.com/repos/edgexfoundry/' + str(repo['name']) + '/stats/contributors?per_page=100', auth=('jpwhitemn','9e396978ef8f2cbbb6613cf1676351742bf672ae'))
